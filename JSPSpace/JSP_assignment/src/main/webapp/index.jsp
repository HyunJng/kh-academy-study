  ...
  <meta charset="UTF-8">
        ...
        <header class="py-5 bg-light border-bottom mb-4">
            <div class="container">
                <div class="text-center my-5">
                    <h1 class="fw-bolder">Welcome Shop</h1>
	...
	<c:otherwise> 
		 <jsp:include page="goodsList.jsp"/>
                ...
                <div class="col-lg-4">
                    <!-- Search widget-->
                    <form action="getGoodsList.do">
                    <div class="card mb-4">
                        <div class="card-header">Search</div>
                        <div class="card-body">
                            <div class="input-group">
                                <input class="form-control" name = "searchkeyword" type="text" placeholder="Enter search term..." aria-label="Enter search term..." aria-describedby="button-search" />
        ...
        $(document).ready(function(){
        	...
        	$("#btn1").click(function() {
    			...
    			var url = 'viewcart.do';
    			location.href = url;
    			window.open('viewcart.do', 'test', 'width=700px,height=800px,scrollbars=yes');
