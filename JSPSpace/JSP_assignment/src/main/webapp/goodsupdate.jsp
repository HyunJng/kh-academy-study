        ...
        <header class="py-5 bg-light border-bottom mb-4">
            <div class="container">
                <div class="text-center my-5">
                    <h1 class="fw-bolder">판매 물품 업데이트</h1>
        ...
        <!-- Page content-->
         <div id="layoutSidenav_content">
                <main>
                   <div class="container">
		<div class="row">
			<form method="post" action="updateArticle.do" enctype="multipart/form-data" accept-charset="UTF-8">
				<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
					<thead>
						<tr>
							<th colspan="2" style="background-color: #eeeeee; text-align: center;">상품 업데이트</th>
						</tr>
					</thead>
					<tbody>
						<tr>
							<td><input type="text" class="form-control" placeholder="${goods.goods }" name="goods" maxlength="50" ></td>
						</tr>
						...
						<tr>
							<td><textarea class="form-control" placeholder="${goods.goods_info }" name="goods_info" maxlength="1028" style="height: 150px;"></textarea></td>
						</tr>
						<tr>
						<td>
						 <div class="row">
					            <div class="col-md-6 mb-3">
					              ...
					              <input type="text" class="form-control" id="cost" name = "cost" placeholder="${goods.cost }" required>
					             <input name="seq" type="hidden" value="${goods.seq }">
					            </div>
					            <div class="col-md-6 mb-3">
					              <label for="nickname">상품 재고</label>
					              <input type="text" class="form-control" id="count" name = "count" placeholder="${goods.count }" required>
				...
				<input type="submit" class="btn btn-primary pull-right" value="상품 업데이트하기">
