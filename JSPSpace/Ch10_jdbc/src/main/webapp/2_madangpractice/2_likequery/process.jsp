...
<% 
	...
	//4. form tag를 가진 jsp에서 넘긴 parameter의 title값 가져오기
	String title = request.getParameter("title");
	//5. sql문 만들기 
	String sql = "select * from book where bookname like '%" + title + "%'";
	//6. sql문 실행하고 결과값 가져오기
	ResultSet rs = stmt.executeQuery(sql);
	
	List<Book> list = new ArrayList<>();	// 동일한 이름의 책이 여러권 올 수 있어서 
