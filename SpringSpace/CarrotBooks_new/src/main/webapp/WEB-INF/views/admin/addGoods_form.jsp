			...
			<div class="col-10">
				...
				<form class="mt-3" action="/admin/addGoods/form" method="post">
					...
					<div class="row ps-2 mt-2">
						...
						<div class="col-10">
							<input class="form-control" name="discountPer" maxlength="2" value="0" required>
...
<script type="text/javascript">
	...
	$("input[name='discountPer']").on("propertychange change keyup paste input", function(){
		...
		let pullPrice = $("input[name='fullPrice']").val();
		
		let discountPrice = pullPrice * (1 - (discountPer/100));
